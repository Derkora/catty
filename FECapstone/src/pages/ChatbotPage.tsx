...
import './ChatbotPage.css'; // Import custom styles
import FeatureCard from '../components/chatbot/FeatureCard'; // Import FeatureCard component
import { formatMarkdown, copyToClipboard } from '../lib/utils'; // Import utility functions
