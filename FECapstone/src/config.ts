...
// export const API_BASE_URL = import.meta.env.VITE_API_BASE_URL || 'http://localhost:1337'; // Strapi URL laptop

// Flask API Base URL
export const FLASK_API_BASE_URL = import.meta.env.VITE_FLASK_API_BASE_URL || 'http://10.4.89.48:5000';
// export const FLASK_API_BASE_URL = import.meta.env.VITE_FLASK_API_BASE_URL || 'http://host.docker.internal:5000';
